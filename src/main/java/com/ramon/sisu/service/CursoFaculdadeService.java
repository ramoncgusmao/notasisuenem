...
public class CursoFaculdadeService {
	...
	public CursoFaculdade editarCursoFaculdade(Integer id, CursoFaculdade cursoFaculdade) {
		...
		cursoSalvo.setRedacaoPeso(cursoFaculdade.getRedacaoPeso() > 0? cursoFaculdade.getRedacaoPeso(): cursoSalvo.getRedacaoPeso());
		cursoSalvo.setNotaMinimaRedacao(cursoFaculdade.getNotaMinimaRedacao() > 0? cursoFaculdade.getNotaMinimaRedacao(): cursoSalvo.getNotaMinimaRedacao());
		cursoSalvo.setMatematicaPeso(cursoFaculdade.getMatematicaPeso() > 0? cursoFaculdade.getMatematicaPeso(): cursoSalvo.getMatematicaPeso());
		cursoSalvo.setNotaMinimaMatematica(cursoFaculdade.getNotaMinimaMatematica() > 0? cursoFaculdade.getNotaMinimaMatematica(): cursoSalvo.getNotaMinimaMatematica());
		cursoSalvo.setLinguagemPeso(cursoFaculdade.getLinguagemPeso() > 0? cursoFaculdade.getLinguagemPeso(): cursoSalvo.getLinguagemPeso());
		cursoSalvo.setNotaMinimaLinguagem(cursoFaculdade.getNotaMinimaLinguagem() > 0? cursoFaculdade.getNotaMinimaLinguagem(): cursoSalvo.getNotaMinimaLinguagem());
		cursoSalvo.setNaturezaPeso(cursoFaculdade.getNaturezaPeso() > 0? cursoFaculdade.getNaturezaPeso(): cursoSalvo.getNaturezaPeso());
		cursoSalvo.setNotaMinimaNatureza(cursoFaculdade.getNotaMinimaNatureza() > 0? cursoFaculdade.getNotaMinimaNatureza(): cursoSalvo.getNotaMinimaNatureza());
		cursoSalvo.setHumanaPeso(cursoFaculdade.getHumanaPeso() > 0? cursoFaculdade.getHumanaPeso(): cursoSalvo.getHumanaPeso());
		cursoSalvo.setNotaMinimaHumana(cursoFaculdade.getNotaMinimaHumana() > 0? cursoFaculdade.getNotaMinimaHumana(): cursoSalvo.getNotaMinimaHumana());
		cursoSalvo.setPossuiCotaRegional(cursoFaculdade.isPossuiCotaRegional() != cursoSalvo.isPossuiCotaRegional()? cursoFaculdade.isPossuiCotaRegional(): cursoSalvo.isPossuiCotaRegional());
		cursoSalvo.setPorcentagemRegional(cursoFaculdade.getPorcentagemRegional() > 0? cursoFaculdade.getPorcentagemRegional(): cursoSalvo.getPorcentagemRegional());
